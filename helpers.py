...
def get_date_range(timeframe, starting_date = datetime.today() + timedelta(days=1)):
    if timeframe == 'days':
        return (starting_date - timedelta(days=1)).strftime("%Y-%m-%d")
    elif timeframe == 'weeks':
        return (starting_date - timedelta(days=7)).strftime("%Y-%m-%d")
    elif timeframe == 'months':
        return (starting_date - timedelta(weeks=4)).strftime("%Y-%m-%d")
    elif timeframe == 'years':
        return (starting_date - timedelta(days=365)).strftime("%Y-%m-%d")
    else:
        return None
